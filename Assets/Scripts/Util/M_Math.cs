...
{
   /// <summary>
   /// Returns the relative position on the given camera (unclamped) of the given transform 
   /// </summary>
   /// <param name="transform"></param>
   /// <param name="cam"></param>
   /// <returns></returns>
    public static Vector3 GetRelativeScreenPos(this Transform transform, Camera cam)
    {
    ...
    public static Vector2 WorldToCanvasPosition(RectTransform canvas, Camera camera, Vector3 position, Vector2 pixelOffset)
    {
