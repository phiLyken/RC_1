...
////// Emissive:
                ...
                float2 node_4892 = float2((1.0 - saturate((((1.0 - 1.0)*1.0+-0.5)+(node_9669+(node_9669*(_DissolvePattern_var.r*0.9+0.1)))))),0.0);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_4892 = float2((1.0 - saturate((((1.0 - 1.0)*1.0+-0.5)+(node_9669+(node_9669*(_DissolvePattern_var.r*0.9+0.1)))))),0.0);
                float4 node_3877 = tex2D(_DissolveRamp,TRANSFORM_TEX(node_4892, _DissolveRamp));
                o.Emission = (_BloomIntesity*node_3877.rgb);
