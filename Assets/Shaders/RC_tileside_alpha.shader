...
////// Lighting:
////// Emissive:
                float2 node_2545 = float2(i.posWorld.r,i.posWorld.b);
                float4 _MainTex_var = tex2D(_MainTex,TRANSFORM_TEX(node_2545, _MainTex));
