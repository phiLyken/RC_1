    ...
    SubShader {
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : COLOR {
                ...
                float4 node_399 = tex2D(_zClamp,TRANSFORM_TEX(node_2373, _zClamp)); // y axis opacity clip
...
/////// Diffuse:
                ...
                float node_9449 = ((1.0 - node_8602.r)*(node_3617.r+(-1*node_3453.r)));
...
////// Emissive:
                ...
                float3 emissive = ((_BloomIntesity*(node_1855.rgb+node_3877.rgb)*(1.0 - node_2040.r))+((1.0 - node_9449)*((1.0-max(0,dot(normalDirection, viewDirection)))*_HologramColor.rgb*(node_614*0.25+0.5))));
/// Final Color:
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float2 node_614_rnd = 4.789*sin(489.123*(node_614_skew));
                float node_614 = frac(node_614_rnd.x*node_614_rnd.y*(1+node_614_skew.x));
                o.Emission = ((_BloomIntesity*(node_1855.rgb+node_3877.rgb)*(1.0 - node_2040.r))+((1.0 - node_9449)*((1.0-max(0,dot(normalDirection, viewDirection)))*_HologramColor.rgb*(node_614*0.25+0.5))));
