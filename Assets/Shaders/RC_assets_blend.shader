...
////// Emissive:
                ...
                float3 node_7371 = (_BloomIntesity*(node_1855.rgb+node_3877.rgb)*node_2040.r);
                ...
                float3 emissive = (node_7371+((1.0 - node_9449)*((1.0-max(0,dot(normalDirection, viewDirection)))*_HologramColor.rgb*(node_614*0.25+0.5))));
/// Final Color:
