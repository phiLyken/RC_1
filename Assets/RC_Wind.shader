...
////// Emissive:
                ...
                float2 node_4672 = ((i.uv0*node_9691)+node_5538.g*float2(0.5,-1));
                float4 node_1104 = tex2D(_node_7961,TRANSFORM_TEX(node_4672, _node_7961));
                fixed4 finalRGBA = fixed4(finalColor,(saturate((node_8336*node_5894.b*(node_1104.r+node_8995)*_WindStrenght))*i.vertexColor.a));
